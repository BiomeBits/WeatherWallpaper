...
Task Scheduler is a pain. Sometimes it just won't run the batch file even when you can run it yourself fine. Try unticking 'run whether use is logged on or not' if you have problems.
